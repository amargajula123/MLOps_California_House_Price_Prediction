...
VERSION = "0.0.4"
AUTHOR = "Amar Gajula"
DESCRIPTION = "This is 2025/8th month ML project, its about California house price prediction using regression on housing dataset."
REQUIREMENT_FILE_NAME = "requirements.txt"

def get_requirements_list() -> List[str]:
    """
    Description: 
    Returns a list of dependencies/libraries from 
    requirements.txt, excluding '-e .'
    """
...
# we have packages=find_packages() this is for all the package where ever there is __init__.py file
...
# so here in requirements.txt "-e ." will also search for (internal pakages) all the files for the instalation
# that is the ression we removed (-e.) from requirements.txt so that External will be install