...
class HousingEstimatorModel:
    def __init__(self, preprocessing_object, trained_model_object):
        ...
        """
        self.preprocessing_object = preprocessing_object  # preprocessing_object is nothing but the object that we created during the Datatransformation phase  
        self.trained_model_object = trained_model_object  # trained_model_object is nothing but the object that we craeted after Traing dataset the model object is created, on trained model object we call predict function 
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            logging.info(f"Extracting model config file path")#model_config_file_path='config\\model.yaml'
