...
def save_object(file_path:str,obj):
    """
    for saving preprocessing object as pickle file
    file_path: str
    obj: Any sort of object this will save pickle file
    """
    try:
        dir_path = os.path.dirname(file_path)
        os.makedirs(dir_path,exist_ok=True)
...
def load_object(file_path:str):
    """
    for loading preprocessing object of pickle file
    file_path:str read pickle file 
    """
    try:
        with open(file_path, "rb") as file_obj:
