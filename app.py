...
# when you hit Url it starts here tamplate means means you access here
...
def predict():
    ...
    if request.method == 'POST':
        ...
        housing_predictor = HousingPredictor(model_dir=MODEL_DIR) # giving Saved_model location
